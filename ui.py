...
class Ui:
    ...
    def __init__(self, simulation, window):
        ...
        self.healthy_counter.place(x=self.simulation.canvas_size[0] - self.simulation.ui_space + 30, y=self.simulation.canvas_size[1] // 8 + 40)
        ...
        self.sick_counter.place(x=self.simulation.canvas_size[0] - self.simulation.ui_space + 30, y=self.simulation.canvas_size[1] // 8 + 80)
        ...
        pause_button.pack()
        pause_button.place(x=self.simulation.canvas_size[0] - self.simulation.ui_space + 30, y=self.simulation.canvas_size[1] // 8)
        ...
        stop_button.pack()
        stop_button.place(x=self.simulation.canvas_size[0] - self.simulation.ui_space + self.simulation.ui_space // 3, y=self.simulation.canvas_size[1] // 8)
